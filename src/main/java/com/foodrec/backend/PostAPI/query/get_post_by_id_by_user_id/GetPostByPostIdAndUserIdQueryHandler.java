...
@Component
public class GetPostByPostIdAndUserIdQueryHandler implements Command.Handler<GetPostByPostIdAndUserIdQuery, PostDTO> {
    ...
    public GetPostByPostIdAndUserIdQueryHandler(PostRepository postRepository,
    ...
    @Transactional
    @Override
    public PostDTO handle(GetPostByPostIdAndUserIdQuery query) {
        if (query.getPostId().isEmpty()) {
            throw new InvalidDataExceptionHandler("Invalid data!");
        }
        Optional<Post> optionalPost = postRepository.getPostByPostIdAndUserId(query.getPostId(), query.getUserId());
