...
(
    ...
    userid character varying(30) COLLATE pg_catalog."default" NOT NULL,
    moderatorid character varying(30) COLLATE pg_catalog."default",
    recipename character varying(255) COLLATE pg_catalog."default" NOT NULL,
    description character varying(255) COLLATE pg_catalog."default" NOT NULL,
    calories integer NOT NULL,
    duration integer NOT NULL,
...
(
    tagid character varying(30) COLLATE pg_catalog."default" NOT NULL,
    recipeid character varying(30) COLLATE pg_catalog."default" NOT NULL,
...
(
    ...
    collectionid character varying(30) NOT NULL,
